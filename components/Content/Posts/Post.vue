      ...
      <v-card-title primary-title>
        <v-btn icon :to="'/content/wall/' + postData.user.username" nuxt>
          <v-avatar :size="40" class="elevation-2">
            <img :src="postData.user.avatar ? postData.user.avatar : '/avatar.png'">
          </v-avatar>
        </v-btn>
        ...
        <span v-if="postData.approved && postData.user.username !== username">
          <v-dialog v-model="dialog">
            ...
            <v-card>
              <v-card-text>
                <p class="green--text">این پست تایید شده که یعنی در صفحه مربوط به شما در نشریه یادبود فارغ‌التحصیلی چاپ میشه و همچنین روی دیوار شما برای عموم قابل نمایشه.</p>
